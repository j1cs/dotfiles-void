...
rm /home/glats/.local/share/wofi/exit.cache

A=$(wofi --show dmenu --width=100 --height=170 --cache-file=/home/glats/.local/share/wofi/exit.cache --prompt=System cat <<EOF
 Lock
 Logout
 Reboot
 Shutdown
